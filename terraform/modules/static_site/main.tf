...
# The TXT record below picks up the token. Validation completes automatically
# once Azure sees the TXT record (or on second apply).
...
# Uses the validation token generated by the custom domain resource.
resource "azurerm_dns_txt_record" "dev_site_validation" {
  ...
  record {
    value = azurerm_static_web_app_custom_domain.dev_site.validation_token
  }
}
